**EXCELENTÍSSIMO SENHOR PRESIDENTE DA CÂMARA MUNICIPAL DE SANTOS**
...
**RUI SÉRGIO GOMES DE ROSIS JUNIOR**, Vereador da Câmara Municipal de Santos (PL), no
exercício do dever de fiscalização que lhe impõe o art. 31 da Constituição Federal, vem
requerer a Vossa Excelência, nos termos do **art. 121 do Regimento Interno**, que se digne
oficiar ao Excelentíssimo Senhor Prefeito Municipal, para que preste, no prazo de 30 (trinta)
dias (art. 120, parágrafo único, do Regimento Interno), as informações adiante especificadas.

## I – DOS FATOS

O Município de Santos realizou, em 2025, **duas licitações para o mesmo produto**, com
especificação técnica idêntica: piso de borracha tipo moeda, antiderrapante, com dimensões
aproximadas de 100 cm de largura (rolo de 20 m) e espessura de 3,5 mm, na cor preta.
...
| Desconto obtido sobre a estimativa | **0,05%** (R$ 1,12) | **48,56%** (R$ 1.264,96) |
| Preço por m² (rolo de 20 m²) | **R$ 102,74** | **R$ 67,00** |
| Data do resultado | 03/04/2025 | 14/11/2025 |
| Quantidade registrada | 3.755 rolos | 828 + 275 rolos |
| Valor total homologado | **R$ 7.716.036,85** | R$ 1.478.020,00 |
...
depois, o desconto foi de 48,56%.

**Segundo: a estimativa subiu enquanto o preço de mercado caiu.** A Administração estimou o
mesmo item em R$ 2.055,99 em fevereiro e em R$ 2.604,96 em setembro — uma elevação de 26,7%
na expectativa de preço. No entanto, o preço efetivamente obtido no segundo certame foi 34,8%
**inferior** ao do primeiro. A pesquisa de preços que fundamentou ambos os certames, portanto,
...
quesitos abaixo pretendem esclarecer.

**Terceiro: a compra de grande volume saiu ao preço de varejo.** Consulta ao PNCP abrangendo
as contratações de nove municípios paulistas de porte comparável localizou um único ente com
o mesmo produto e preço já homologado: o **Fundo Municipal de Saúde de São José dos Campos**,
que em 07/07/2025 adquiriu piso moeda emborrachado por **R$ 309,90 o rolo de 1 m × 3 m** —
isto é, **R$ 103,30 por m²**.
...
R$ 0,56 por m². Registre-se que a comparação com São José dos Campos não é apresentada como
parâmetro de mercado, dada a enorme disparidade de escala; ela é trazida justamente porque
essa disparidade é o ponto: uma compra de 75 mil m² não deveria custar, por metro quadrado, o
mesmo que uma compra de 6 m² feita por microempresária individual.

Anote-se, por fim, que Jundiaí (R$ 113,34 e R$ 122,22 o metro) e São Vicente (R$ 100,31 o m²)
possuem licitações do mesmo produto ainda em andamento, com valores estimados na mesma ordem
de grandeza — o que reforça que a faixa em torno de R$ 100/m² corresponde a compras de pequeno
...
parâmetros de pesquisa, a consulta a bancos de dados públicos e a contratações similares de
outros entes federativos. Os dois certames em exame sugerem que esse comando pode não ter sido
observado com o rigor devido.

## III – DOS QUESITOS

Requer-se, assim, sejam prestadas as seguintes informações:

1. **Cópia integral** dos autos dos Processos Administrativos nº **58205/2024-16** e
   nº **31976/2025-56**, incluindo termos de referência, pesquisas de preços, mapas
   comparativos, atas de sessão pública, propostas apresentadas, pareceres jurídicos, termos
...
9. Se a Administração **identificou a diferença de preço** entre os dois certames e se houve
   qualquer apuração interna, manifestação da Controladoria-Geral do Município ou comunicação
   aos órgãos de controle a respeito.

10. Quais **unidades administrativas** foram atendidas por cada uma das atas e qual a
...
11. Considerando que o Município realizou, no exercício de 2025, ao menos **três registros de
   ...
   Administração dispõe de **avaliação comparativa** dos resultados dos três certames.
...
- o mesmo Município, comprando o mesmo item com a mesma descrição, obteve preço **53% menor**
  sete meses depois, partindo de uma estimativa ainda **mais alta** — o que afasta a hipótese
  de mercado sem alternativa;
- o preço de fevereiro equivale ao que um fundo municipal de outra cidade pagou comprando
  **12,5 mil vezes menos** — o que afasta a hipótese de preço de atacado bem negociado;
- no mesmo exercício, outra ata de piso de borracha, de valor **quase o dobro**, obteve
  descontos superiores a 40% — o que afasta a hipótese de que o porte da contratação
  desestimule a disputa.

Não se imputa, aqui, irregularidade a qualquer agente público: as informações requeridas
destinam-se justamente a permitir que a Administração apresente a explicação técnica que os
dados públicos, isoladamente, não fornecem.

A dúvida que se coloca não é sobre a legalidade formal dos atos, mas sobre a **economicidade**
— princípio expresso no art. 70 da Constituição Federal e critério central do controle externo
exercido por esta Casa. O contribuinte santista tem direito de saber por que o mesmo produto
custou o dobro em fevereiro do que custaria em novembro, e se a Administração adotou alguma
providência ao constatar a diferença.

As informações ora requeridas destinam-se exclusivamente ao exercício do controle parlamentar
e não importam, nos termos do art. 121, § 1º, do Regimento Interno, qualquer sugestão ou
conselho à autoridade consultada.

Nestes termos, pede deferimento.

Santos, \_\_\_\_ de \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ de 2026.
...
### Nota de apuração (uso interno, não integra a peça)

Todos os valores foram extraídos da API pública do PNCP e reconferidos na fonte primária em
09/08/2026 (endpoints `/api/pncp/v1/orgaos/58200015000183/compras/2025/{96,492,556}/itens` e
`/itens/{n}/resultados`). Os totais das atas conferem com o campo `valorTotalHomologado` de
cada contratação: R$ 7.716.036,85 (96/2025) e R$ 14.490.000,00 (492/2025).

A comparação com as demais cidades vem de varredura das contratações de nove municípios
paulistas (Guarujá, São Vicente, Praia Grande, Cubatão, Jundiaí, Piracicaba, Mogi das Cruzes,
...
3. **Cruzamento com a execução (não usado na peça, por não ser conclusivo).** Na Base de
   Despesas do gabinete, a Eletridal aparece com R$ 12.255,24 pagos em 2 lançamentos, e a
   Tarará com R$ 1.337.221,55 em 33 lançamentos — destes, R$ 1.056.264,21 após 14/11/2025,
   majoritariamente no elemento "material para manutenção de bens imóveis". Esses números
   **sugerem** que a ata cara foi pouco utilizada, mas não provam: os pagamentos não são
   identificáveis por item, e a Tarará já recebia do Município antes da ata (R$ 280.957,34 até
   13/11/2025). Por isso o assunto entrou como **quesito 6**, e não como afirmação.
